...
def test_t1ha2_atonce(hash_tester):
    hash_tester(
        hasher_type=pyhash.t1ha2_atonce,
...
def test_t1ha2_atonce128(hash_tester):
    hash_tester(
        hasher_type=pyhash.t1ha2_atonce128,
...
def test_t1ha2_128_perf(benchmark, hash_bencher):
    hash_bencher(benchmark, pyhash.t1ha2_128, 263168739977411690410017013291704716368)
